...
public class readCSVMask {
        public static HashMap<String, City> fromFileToCity(File file) {
                ...
                computers.add(new DayLinearSquaredProfile("computers starting", new YearConstant(0.1),
                                new YearConstant(200),
                                new Square(new YearConstant(60), new YearConstant(8 * 60 - 30)),
                                new WeekVariation(-1)));
                ...
                computers.add(new DayLinearSquaredProfile("computers finishing", new YearConstant(200),
                                new YearConstant(0.1),
                                new Square(new YearConstant(60), new YearConstant(18 * 60 - 30)),
                                new WeekVariation(-1)));
