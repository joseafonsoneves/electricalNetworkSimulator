...
/**
 * Class created to mask the read csv extension so that I can anticipate how to
 * integrate both
 * 
...
public class readCSVMask {
    public static City fromFileToCity(File file) {
        ...
        joseHouse.add(new DayConstantSquaredProfile("heating", new YearSinusoid(12, 8, 0),
                new Square(new YearConstant(12 * 60), new YearConstant(20 * 60)), new YearVariation(270, 180)));
        ...
        tv.add(new DayConstantSquaredProfile("tv weekdays", new YearConstant(20),
                new Square(new YearConstant(20), new YearConstant(7 * 60 + 40), 2, 13 * 60), new WeekVariation(-1)));
        tv.add(new DayConstantSquaredProfile("tv weekend", new YearConstant(20),
                new Square(new YearConstant(4 * 60), new YearConstant(14 * 60)), new WeekVariation(-2)));
        // joseHouse.add(tv);
        ...
        joseOffice.add(new DayConstantSquaredProfile("Lights", new YearConstant(200),
                new Square(new YearConstant(11 * 60), new YearConstant(8 * 60 - 30)), new WeekVariation(-1)));
        ...
        computers.add(new DayLinearSquaredProfile("computers starting", new YearConstant(0.1), new YearConstant(200),
                new Square(new YearConstant(60), new YearConstant(8 * 60 - 30)), new WeekVariation(-1)));
        computers.add(new DayConstantSquaredProfile("computers normal", new YearConstant(200),
                new Square(new YearConstant(10 * 60 - 60), new YearConstant(8 * 60 + 30)), new WeekVariation(-1)));
        computers.add(new DayLinearSquaredProfile("computers finishing", new YearConstant(200), new YearConstant(0.1),
                new Square(new YearConstant(60), new YearConstant(18 * 60 - 30)), new WeekVariation(-1)));
        ...
        city.addProducer(new DayQuadraticSquaredProfile("solar plant", new YearConstant(0.1),
                ...
                new Square(new YearSinusoid(14 * 60, 10 * 60, 180), new YearSinusoid(8 * 60, 6 * 60, 365 / 2 - 180))));
