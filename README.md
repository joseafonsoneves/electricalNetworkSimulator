...
Pour les variations dans le même jour, j’ai considéré deux types de profils : les profils qui durent toute la journée et les profils qui durent seulement une partie de la journée et qui peuvent se répétir. Les premiers ont une implémentation simple et je présente un exemple dans la classe «DayConstantProfile». Les seconds peuvent en fait représenter les premiers si la durée appropriée est définie et pour eux, je présente trois types différents, constants, linéaires et quadratiques. Pour représenter le fait qu’ils commencent à un certain instant, ont une certaine durée et peuvent être périodiques, j’ai créé la classe «Square» et les ai fait hériter de la classe abstraite «SquaredProfile» qui a un attribut «Square» et les attributs des différentes variations annuelles.
...
Nous avons réussi à intégrer toutes les extensions.
...
Pour faire l'intégration entre l'extension 2 et 4 des nouvelles méthodes pour lire les nouveaux genres de Profils ont été créés.
...
![Exemple de choix de profils ou pertes](/images/interfaceIntegrationProfilesChoice.png)
